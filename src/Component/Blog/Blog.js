...
const Blog = () => {
    return (
        <div className='bg-sky-300 p-4'>
           <div className='bg-slate-100 w-9/12 mx-auto mt-4 p-10'>
           ...
           <div className='bg-slate-100 w-9/12 mx-auto mt-8 p-10'>
           ...
           <div className='bg-slate-100 w-9/12 mx-auto my-6 p-10'>
